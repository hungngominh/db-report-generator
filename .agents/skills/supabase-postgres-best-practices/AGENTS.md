...
**Solution Engine** (used by db-report-generator v3.0+):
- `references/solution-index.md` - Problem-to-fix mapping with SQL/code templates, priority rules, and impact estimation

---

*31 reference files across 8 categories + 1 solution engine*